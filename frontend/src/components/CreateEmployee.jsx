    ...
    <div className="mt-5">
        ...
        <div className="card w-50 offset-3 p-3">
               ...
               <form>
                    ...
                    <input type="text" id="deptName" name="deptName" className="form-control" autoComplete="off"
                    ...
                    <input type="text" id="designation" name="designation" className="form-control" autoComplete="off"
